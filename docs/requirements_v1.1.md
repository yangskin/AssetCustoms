...
5.2 资产重命名/移动：使用 EditorAssetLibrary.rename_asset()；根据 target_path_template 计算最终路径；遵循 conflict_policy；按 asset_naming_template 和 suffix 命名；将 StaticMesh 与新贴图从 Isolation_Path 移动到最终路径。
